...
import com.ting.sonik.data.MusicDatabase
...
import com.ting.sonik.audio.BalanceEffect
import com.ting.sonik.audio.DynamicsEffect
import com.ting.sonik.audio.LoudnessEffect
import com.ting.sonik.audio.ReverbEffect
import com.ting.sonik.ui.activities.Sonik
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    companion object {
        const val ACTION_PLAY = "com.ting.sonik.ACTION_PLAY"
        const val ACTION_PAUSE = "com.ting.sonik.ACTION_PAUSE"
        const val ACTION_PREVIOUS = "com.ting.sonik.ACTION_PREVIOUS"
        const val ACTION_NEXT = "com.ting.sonik.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.ting.sonik.ACTION_SHUFFLE"
        const val ACTION_FAVORITE = "com.ting.sonik.ACTION_FAVORITE"
    ...
    private fun showNotification(song: Song, isPlaying: Boolean, art: android.graphics.Bitmap? = null) {
        ...
        val intent = Intent(this, Sonik::class.java).apply {
    ...
    private fun updateWidget() {
        ...
        serviceScope.launch {
            ...
            val componentName = ComponentName(applicationContext, SonikWidgetProvider::class.java)
            ...
            if (song != null) {
                ...
                if (lastSongForRounded != song || cachedRoundedArt == null) {
                    ...
                    if (art != null) {
                        ...
                        withContext(Dispatchers.IO) {
                            cachedRoundedArt = SonikWidgetProvider.getRoundedCornerBitmap(art, 40)

                            // Also update blur cache if song changed
                            if (lastSongForBlur != song) {
                                lastSongForBlur = song
                                lastBlurredBitmap = SonikWidgetProvider.getBlurredBitmap(this@MusicService, art, 25, 25)
                            }
                        }
                    } else {
            ...
            // Open App
            val intent = Intent(applicationContext, Sonik::class.java).apply {
                flags = Intent.FLAG_ACTIVITY_SINGLE_TOP or Intent.FLAG_ACTIVITY_NEW_TASK
            }
