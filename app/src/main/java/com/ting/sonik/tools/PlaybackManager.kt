...
import com.ting.sonik.tools.playlist.QueueManager
...
class PlaybackManager private constructor(private val context: Context) {
        ...
        managerScope.launch(Dispatchers.IO) {
            try {
                ...
                if (existing != null) {
                    ...
                    dao.insertStats(com.ting.sonik.data.PlaybackStats(
                        id = id,
                        type = type,
    ...
    fun checkPlaylistStatus() {
        ...
        kotlinx.coroutines.MainScope().launch {
            val count = com.ting.sonik.data.MusicDatabase.getDatabase(context).playlistDao().getPlaylistCountForSong(songId)
