...
import com.ting.sonik.tools.PlaylistBackupManager
    ...
    Surface(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = stringResource(com.ting.sonik.R.string.backup_warning_title),
                    fontWeight = FontWeight.Bold,
                ...
                Text(
                    text = stringResource(com.ting.sonik.R.string.backup_warning_desc),
